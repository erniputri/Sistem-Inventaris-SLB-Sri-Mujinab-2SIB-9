...
@error('kapasitas') is-invalid @enderror" name="kapasitas" rows="5" placeholder="Jumlah Kapasitas">{{ old('pass')}}</textarea>
...
@error('fasilitas') is-invalid @enderror" name="fasilitas" rows="5" placeholder="Nama fasilitas">{{ old('pass') }}</textarea>
