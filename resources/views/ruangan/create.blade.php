...
@error('kapasitas') is-invalid @enderror" name="kapasitas" >
...
@error('fasilitas') is-invalid @enderror" name="fasilitas" rows="5" placeholder="Masukkan barang yang tersedia">{{ old('pass') }}</textarea>
