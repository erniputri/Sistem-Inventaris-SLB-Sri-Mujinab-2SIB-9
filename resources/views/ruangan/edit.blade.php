...
initial-scale=1.0">
    ...
    <title>Tambah Ruangan - Jadwal Ruangan</title>
...
@error('kapasitas') is-invalid @enderror" name="kapasitas" value="{!! $data->kapasitas!!}">
...
@error('fasilitas') is-invalid @enderror" name="fasilitas" rows="5" placeholder="Masukkan jumlah barang">{{ $data->fasilitas}}</textarea>
