...
@error('kapasitas') is-invalid @enderror" name="jumlah" value="{!! $data->jumlah!!}">
...
@error('kondisi') is-invalid @enderror" name="kondisi" rows="5" placeholder="Masukkan jumlah barang">{{ $data->kondisi}}</textarea>
